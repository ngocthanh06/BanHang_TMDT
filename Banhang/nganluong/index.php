...
<table> <?php _debug($user['account']);
 ?>
	<tr><th><strong>Họ Tên:</strong></th><td><input  type="text" name="txh_name" size="28" placeholder="Họ tên" value="<?php echo $user['account'] ?>" /></td></tr>
	<tr><th><strong>Email:</strong></th><td><input  type="text" name="txt_email" size="28" placeholder="địa chỉ email" value="<?php echo $user['email'] ?>" /></td></tr>
	<tr><th><strong>Số điện thoại:</strong></th><td><input  type="text" name="txt_phone" size="28" placeholder="Số điện thoại" value="<?php echo $user['phone'] ?>" /></td></tr>
	<tr><th><strong>Số tền thanh toán:</strong></th><td><input name="txt_gia" type="text" size="28" placeholder="Số tiền thanh toán" value="<?php echo formatprice($_SESSION['total']) ?>"/></td></tr>	
