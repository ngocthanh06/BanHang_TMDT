<?php 
        ...
        if($_SERVER["REQUEST_METHOD"]=="POST")
    {
        ...
        if($id_tran>0)
            ...
            $content = 'Xin chào khách hàng '.$user['account'].'. Đơn đặt hàng sản phẩm thành công..!! Mọi chi tiết phản hồi xin liên hệ chúng tôi qua đường dây nóng 0123456 hoặc email thanhlongtmdt@gmail.com';
            $nTo = $user['account'];
            $mTo =  $user['email'];
            $diachicc =  $user['email'];
