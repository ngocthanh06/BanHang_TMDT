<?php  
    ...
    if(isset($id))
    {
    $update = $db->update("product", array('view' => $product['view']+1 ),array('id' =>$id ));
    }
    ...
    <section class="box-main1" >
        ...
        <div class="col-md-6 " style="margin-top: 20px;padding: 30px;">
            <ul id="right">
                ...
                <li><a href="giohang/addcart.php?id=<?php echo $item['id'] ?>" class="btn btn-default"> <i class="fa fa-shopping-basket"></i>Thêm vào giỏ hàng</a></li>
            </ul>
        </div>
    </section>
       ...
       $com = $db->fetchsql($a);
        ...
        <?php foreach ($user as $value):?>
                <div class="media-heading" style="margin-top: 10px">
                  <button class="btn btn-default btn-xs" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseExample"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span></button> <span class="label label-info"><?php echo $value['name'] ?></span> 
