  ...
  /**   { 
           ...
           $name = $_POST['name'];//Tiếp nhận dữ liệu
        
            $sql = "INSERT INTO muc(name) VALUES ('$name')";          
            if ($conn->query($sql) === TRUE) {
                echo "Đã Tạo thành công";
            } else {empty($name);
               $nameS="Mời bạn nhập thông tin";
            }
            ...
            <form class="form-horizontal" action="" method="POST"enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <label for="InputEmail1" class="col-sm-2"> Hình ảnh</label>
                        <div class="col-sm-3">
                        <input type="file" class="form-control" id="exampleInputEmail1" name="images" required="">
                   <!--nếu tồn tại mảng lỗi error in lỗi tại vị trí-->
